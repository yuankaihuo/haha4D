...
public:
  ...
  typedef std::vector<double>						 RealType2D;
  ...
  /**
  * Set/Get the timePoints parameter---how many time points for the target
  * the inverse.  Default = 1.
  */
  itkSetMacro(timePoints, unsigned int);
  itkGetConstMacro(timePoints, unsigned int);
